...
void sync_collect_changes     (struct s_sync*, char*, struct s_sync_changes *);
void sync_changes_init        (struct s_sync_changes *);
void sync_changes_append      (struct s_sync_changes *, char *, struct dirent *, struct stat *);
void sync_store_tts           (struct s_sync *);

void sync_debug_list_changes  (struct s_sync_changes *);
